...
- [x] `pagamento.html` → input `readonly` com a chave PIX acima do botão de copiar

### 4. Frontend - Outras páginas de pagamento
- [x] `pagamentototal.html` (R$12,50) → QR Code + download + botão copiar chave PIX + input readonly
- [x] `pagamentoanalise.html` (R$5,99) → QR Code + download + botão copiar chave PIX + input readonly
- [x] `pagamentototalanalise.html` (R$12,50) → QR Code + download + botão copiar chave PIX + input readonly
