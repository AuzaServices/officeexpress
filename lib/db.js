...
async function garantirSchema() {
  try {
    ...
    await garantirColunaSegura("parceiros", "tipo", "tipo VARCHAR(10) NOT NULL DEFAULT 'independente'");
    ...
    // ficam 'filho'. Também tolerante a falha (coluna pode não existir ainda).
    try {
