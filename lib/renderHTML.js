...
function montarClassico(dados) {
  ...
  return `
  <div class="cab-topo">
    ${dados.foto ? `<img class="foto" src="${dados.foto}" alt="Foto" />` : ""}
...
const CSS = {
  classico: `
    ...
    .modelo-classico .foto { width:92px; height:92px; border-radius:50%; object-fit:cover; margin:0 auto 10px; border:3px solid #00324a; }
  ...
  moderno: `
    ...
    .modelo-moderno .foto { width:92px; height:92px; border-radius:50%; object-fit:cover; margin:0 auto 14px; border:3px solid rgba(255,255,255,0.6); display:block; }
  ...
  minimal: `
    ...
    .modelo-minimal .foto { width:80px; height:80px; border-radius:50%; object-fit:cover; float:right; }
  ...
  profissional: `
    ...
    .modelo-profissional .foto { width:90px; height:90px; border-radius:50%; object-fit:cover; margin:0 auto 12px; border:3px solid rgba(255,255,255,0.6); }
  ...
  executivo: `
    ...
    .modelo-executivo .foto { width:88px; height:88px; border-radius:50%; object-fit:cover; margin:0 auto 16px; border:2px solid rgba(255,255,255,0.4); display:block; }
  ...
  cronologico: `
    ...
    .modelo-cronologico .foto { width:86px; height:86px; border-radius:50%; object-fit:cover; float:right; }
  ...
  funcional: `
    ...
    .modelo-funcional .foto { width:90px; height:90px; border-radius:50%; object-fit:cover; margin:0 auto 12px; border:3px solid rgba(255,255,255,0.5); display:block; }
  ...
  compacto: `
    ...
    .modelo-compacto .foto { width:64px; height:64px; border-radius:50%; object-fit:cover; margin-bottom:10px; }
  ...
  soberio: `
    ...
    .modelo-soberio .foto { width:84px; height:84px; border-radius:50%; object-fit:cover; margin:0 auto 12px; }
  ...
  tecnico: `
    ...
    .modelo-tecnico .foto { width:82px; height:82px; border-radius:6px; object-fit:cover; float:right; }
