...
const CSS = {
  ...
  executivo: `
    .page { background:#fff; }
    .modelo-executivo .cab-exec { background:#0f172a; color:#fff; text-align:center; padding:38px 48px 30px; border-bottom:5px solid #1e293b; }
    .modelo-executivo .cab-exec .nome { color:#fff; font-size:30px; font-weight:800; text-transform:uppercase; letter-spacing:3px; }
    .modelo-executivo .exec-cargo { color:#e2e8f0; font-size:12px; font-style:italic; margin-top:4px; }
    .modelo-executivo .exec-contato { color:#cbd5e1; margin-top:10px; font-size:11px; }
    .modelo-executivo .corpo-exec { padding:20px 48px 40px; }
