...
const modelos = ["classico","moderno","minimal","profissional","executivo","cronologico","funcional","compacto","soberio","tecnico","elegante","criativo","limpo","tradicional","contemporaneo"];
(async () => {
  let allOk = true;
  ...
  console.log(allOk ? "ALL 15 OK" : "SOME FAILED");
